...
public class AnnuityPaymentCalculation implements PaymentCalculation {
    ...
    public List<Payment> calculatePayment(CreditDetail creditDetail) {
         ...
         */
        BigDecimal numerator = creditDetail.getAmount().multiply(BigDecimal.valueOf(monthInterestRate))
                .setScale(8, BigDecimal.ROUND_HALF_UP);
        BigDecimal denominator = BigDecimal.valueOf(1.0 - Math.pow((1.0 + monthInterestRate), -creditDetail.getTerm()))
                .setScale(8, BigDecimal.ROUND_HALF_UP);
